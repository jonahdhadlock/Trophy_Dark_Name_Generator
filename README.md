...
A procedural name generator written in Python that creates unique, thematic names in the somber, melancholic style of the tabletop RPG *Trophy Dark* by Jesse Ross, published by The Gauntlet.
...
* This project is a fan work inspired by the excellent tabletop RPG **Trophy**, created by Jesse Ross and published by Hedgemaze Press.
